...
# Bot information
SESSION = environ.get('SESSION', 'MovieCineverseBot')
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/w4pv6h.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6367495275').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7066311328').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002428763325'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002089257903').split()]  # For Multiple Id Use One Space Between Each.

#Extra Backup Channel
Backup_Channel = environ.get('BACKUP_CHANNEL', '-1002348853799') # give your force subscribe channel id here else leave it blank
BACKUP_CHANNEL = int(Backup_Channel) if Backup_Channel and id_pattern.search(Backup_Channel) else None
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001860294823') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002089257903')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://garima3206:0MK3cXroLuh4HN8H@cluster0.nwgqi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "garima3206")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'garima3206')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+oYFuD29zhD05MDhl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieCineverse')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MovieCineverse') # Support Chat Link Without https:// or @
